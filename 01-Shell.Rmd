...
> do
>     echo $alkanes
>     car $alkanes > alkanes.pdb
> done
```

¿Cuál sería la diferencia si usamos ahora `>>`?

**Ejercicio:** Crea un ciclo for que muestre las últimas 20 líneas de cada archivo en la carpeta `creatures`.
...
![Debugging](D:/Users/hayde/Documents/R_sites/Computo_Cientifico/img/shell_script_for_loop_flow_chart.svg)
