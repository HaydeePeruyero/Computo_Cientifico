...
pivot_table_df = df.pivot_table(index='fecha', columns='ciudad', values='temperatura', aggfunc='mean')
print(pivot_table_df)
```

En este ejemplo, además de reorganizar los datos, estamos calculando el promedio de la temperatura para cada ciudad en cada fecha.
